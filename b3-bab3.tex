...
Metode penelitian yang digunakan dalam penelitian ini merupakan metode pengembangan perangkat lunak yang disesuaikan dengan karakteristik permasalahan dan tujuan penelitian. Penelitian ini berfokus pada pengembangan aplikasi frontend dashboard analisis sentimen yang bersifat data-driven dan membutuhkan pengelolaan data secara fleksibel serta evaluasi berulang selama proses pengembangan. Oleh karena itu, diperlukan metode penelitian yang mampu mendukung tahapan pengembangan yang tidak bersifat linier dan memungkinkan adanya penyesuaian pada setiap tahapan penelitian.

Berdasarkan pertimbangan tersebut, penelitian ini menggunakan metode Fountain sebagai pendekatan dalam proses pengembangan sistem. Metode Fountain dipilih karena memiliki karakteristik iteratif dan fleksibel, sehingga sesuai untuk mendukung pengembangan frontend yang melibatkan perancangan arsitektur, implementasi, dan pengujian secara saling tumpang tindih. Penjelasan lebih lanjut mengenai metode Fountain dan tahapan penerapannya dalam penelitian ini diuraikan pada subbab berikutnya.
...
\subsection{Tahapan Penerapan Metode Fountain}
...
\begin{packed_enum}
  ...
  \begin{itemize}
    \item \textbf{Perancangan Arsitektur Frontend}
  ...
  \item \textbf{Perancangan Client Data Layer}
  ...
  \item \textbf{Perancangan Penggunaan TanStack Query}
  ...
  \item \textbf{Perancangan Antarmuka}

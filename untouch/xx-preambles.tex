...
%% =========================
%% HALAMAN KOSONG (DUPLEX)
%% =========================
%% =========================
%% HALAMAN KOSONG DUPLEX (BENAR)
%% =========================
\makeatletter
\renewcommand{\cleardoublepage}{%
  ...
  \ifodd\c@page
    % sudah ganjil → lanjut
  \else
    % halaman genap → sisipkan halaman kosong BERTEKS
    \null
    \vfill
    \begin{center}
...
% ===== Buat Manual Halaman Sengaja Kosong
\newcommand{\ganjil}{
  \clearpage
...
\lstdefinelanguage{TypeScript}{
  keywords={const, let, var, function, return, if, else, for, while, import, export, from, class, interface, type, extends, implements, async, await},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={string, number, boolean, any, void},

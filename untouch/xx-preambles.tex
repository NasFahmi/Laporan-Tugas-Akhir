...
% Mengatur warna tabel di jadwal Penelitian
\usepackage{placeins}
...
\usepackage{titlesec}
\titleformat{\chapter}{\doublespacing\fontsize{14pt}{14pt}\bfseries}{\MakeUppercase{\chaptertitlename\ \arabic{chapter}}\filcenter}{0.15cm}{\centering\uppercase}
...
\geometry{
	twoside,
	inner=3cm,          % Margin dalam (untuk jilid)
	outer=3cm,          % Margin luar (SAMA dengan inner)
	top=2cm,
	bottom=2cm,
	bindingoffset=0cm   % Tidak perlu offset tambahan
}
...
% Package untuk halaman kosong yang bersih
\usepackage{emptypage}

% Package untuk hyperref
\usepackage{hyperref} % letakkan di akhir preamble

%==================================================================
% Konfigurasi untuk pencetakan bolak-balik (duplex)
%==================================================================

% Perintah untuk membuat halaman kosong dengan teks DAN nomor halaman
\newcommand{\blankpage}{
	\clearpage
	\null
	\vfill
...
% Perintah untuk halaman benar-benar kosong tanpa teks (tetap ada nomor)
\newcommand{\trulyblankpage}{
	\clearpage
	\mbox{}
	\clearpage
}

% Custom cleardoublepage yang menambah halaman kosong dengan teks DAN nomor halaman
\makeatletter
\renewcommand{\cleardoublepage}{
	...
	\ifodd\c@page
	\else
	% Halaman kosong DENGAN nomor halaman
	\null
	\vfill
	\begin{center}
		\textit{---Halaman ini sengaja dikosongkan---}
...
% Membuat bab selalu dimulai di halaman ganjil

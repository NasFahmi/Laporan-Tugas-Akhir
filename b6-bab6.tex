...
\begin{figure}[H]
    ...
    \caption{Logo Poliwangi dengan scala 0.4}
    \label{fig:logoUNY}
\end{figure}
...
\begin{lstlisting}[language=TeX, caption=Kode untuk Menyisipkan Gambar dalam Dokumen dengan Subfigure, label=lst:kode_gambar_multi]
    \begin{figure}
        ...
        \begin{subfigure}[b]{0.3\textwidth}
            \centering
            \includegraphics[width=\linewidth]{gambar/logo-poliwangi.png}
...
\begin{packed_enum}
    ...
    \item \texttt{\textbackslash includegraphics[width=\textbackslash linewidth]\{gambar-nama\}}: Memasukkan setiap gambar dengan lebar yang sesuai dengan lebar yang telah ditentukan untuk \texttt{subfigure}. 
        \begin{packed_enum}
            \item Gambar pertama menggunakan file \texttt{gambar/logo-poliwangi.png}, dengan caption "Logo Poliwangi".
            \item Gambar kedua menggunakan file \texttt{gambar/logo-poliwangi.png}, dengan caption "Logo Poliwangi".
            \item Gambar ketiga juga menggunakan file \texttt{gambar/logo-poliwangi.png}, dengan caption "Logo Poliwangi".
        \end{packed_enum}

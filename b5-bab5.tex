...
\begin{itemize}
    \item Penerapan arsitektur Client Data Layer pada pengembangan Dashboard Analisis Sentimen UMKM berhasil direalisasikan dengan memanfaatkan TanStack Query sebagai pengelola server state. Arsitektur ini memisahkan secara jelas antara proses pengambilan data dari backend dan komponen antarmuka pengguna, sehingga komponen frontend tidak berinteraksi langsung dengan REST API.

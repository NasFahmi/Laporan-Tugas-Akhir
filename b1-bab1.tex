...
\begin{packed_enum}
  ...
  \item Bagaimana perilaku pengelolaan data \textit{frontend} yang dihasilkan setelah penerapan TanStack Query ditinjau mekanisme \textit{caching}, dan konsistensi data antar-komponen dashboard?
\end{packed_enum}
...
\begin{packed_enum}
  ...
  \item Menganalisis perilaku pengelolaan data \textit{frontend} setelah penerapan TanStack Query, khususnya terkait konsistensi data, caching, dan permintaan API.
\end{packed_enum}

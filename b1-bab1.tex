...
\begin{packed_enum}
  ...
  \item Evaluasi sistem dilakukan menggunakan pendekatan \textit{blackbox testing} dengan mengamati log sistem, tanpa melakukan pengujian performa numerik atau \textit{benchmarking} mendalam.

...
\section{Capaian Jatim Datathon 2025}
Jatim Datathon 2025 merupakan kompetisi analisis data yang diselenggarakan oleh Dinas Komunikasi dan Informatika Provinsi Jawa Timur dengan tema \textit{“Shaping The Future with Open Data”}, yang bertujuan mendorong pemanfaatan Open Data Jawa Timur sebagai dasar dalam analisis data dan perumusan solusi berbasis data. Keikutsertaan dalam kompetisi ini menghasilkan capaian awal berupa perumusan ide, penyusunan proposal, serta pengembangan prototipe solusi yang berangkat dari permasalahan nyata dan data terbuka yang tersedia.

Capaian yang diperoleh pada Jatim Datathon 2025 menjadi dasar pengembangan penelitian pada Tugas Akhir ini. Ide solusi, rancangan awal sistem, serta pendekatan analisis yang dikembangkan selama kompetisi tidak berhenti pada konteks lomba, melainkan dilanjutkan dan disempurnakan melalui proses penelitian yang terstruktur. Pada tahap lanjutan, sistem dikembangkan kembali dengan memperhatikan aspek arsitektur frontend, penerapan Client Data Layer menggunakan TanStack Query, serta evaluasi perilaku pengelolaan data frontend sesuai dengan metodologi penelitian yang digunakan.

Dengan demikian, capaian Jatim Datathon 2025 tidak hanya dipandang sebagai prestasi kompetitif, tetapi juga sebagai kontribusi awal yang mendukung pengembangan sistem dan penelitian secara akademik. Integrasi antara hasil lomba dan pengembangan lanjutan memungkinkan penelitian ini memiliki landasan implementatif yang kuat, sekaligus memenuhi kaidah ilmiah dalam proses analisis, pengujian, dan pelaporan Tugas Akhir.
...
\caption{Kriteria Penilaian Babak Final Jatim Datathon 2025}
...
Setelah melalui seluruh tahapan seleksi, mulai dari pengajuan proposal hingga babak final, tim JEVON ORDRICK berhasil meraih peringkat ketiga pada Jatim Datathon 2025.

 \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{gambar/gambar-juara-3.jpeg}
    \caption{Pengumuman Juara 3 Jatim Datathon 2025}
    \label{fig:juara-3}
  \end{figure}
  \FloatBarrier
Pada Gambar \ref{fig:juara-3} ditunjukkan bahwa tim JEVON ORDRICK berhasil meraih peringkat ketiga pada Jatim Datathon 2025 melalui pengembangan dashboard analisis sentimen yang bertujuan membantu pelaku UMKM dalam menganalisis persepsi masyarakat terhadap produk atau layanan mereka berdasarkan data media sosial Instagram.
\section{Hasil}
...
Halaman rekomendasi konten diimplementasikan untuk menyajikan rekomendasi konten yang dihasilkan berdasarkan hasil analisis sentimen. Data rekomendasi diperoleh dari backend dan dikelola melalui Client Data Layer sebelum ditampilkan pada antarmuka pengguna. Dengan demikian, fitur ini memanfaatkan hasil analisis sebagai dasar penyusunan rekomendasi yang relevan.
...
Hasil implementasi menunjukkan bahwa data rekomendasi yang ditampilkan pada halaman rekomendasi konten dan dashboard selalu selaras. Setiap pembaruan data pada Client Data Layer secara otomatis direfleksikan pada kedua halaman tersebut, yang menandakan bahwa pengelolaan data frontend berjalan secara terintegrasi dengan mengacu pada satu sumber data yang dipercaya
...
Implementasi fitur chatbot ini menunjukkan penerapan Client Data Layer pada skenario komunikasi interaktif berbasis permintaan pengguna. Dengan memanfaatkan mekanisme \textit{mutation}, interaksi chatbot dapat diintegrasikan ke dalam arsitektur frontend secara konsisten tanpa mengganggu pengelolaan server state pada fitur dashboard lainnya.
...
TanStack Query dirancang secara khusus untuk mengelola data yang bersumber dari server, seperti proses pengambilan data, mekanisme caching, serta sinkronisasi data antara frontend dan backend. Pendekatan ini berfokus pada pengelolaan \textit{server state}, yaitu data yang bersifat asinkron dan berasal dari sistem eksternal, sehingga tidak secara langsung mencakup pengelolaan \textit{client state} yang bersifat lokal dan tidak bergantung pada data server.
